...
from RLModels import DQNControl,DQNControl2
...
class TestAgent():
    def __init__(self):
        ...
        self.epsilon = 0. # The exploration rate
        ...
        self.loadModel(self.model, "Params","epoch_DQN1002_48_metrics_-47428.740.param") #1.4232
    ################################
    ...
    def getRewards(self, mark, upstreamThreshold, downstreamThreshold, observationsForAgent, nextObservationForAgent, infoForAgent,nextInfoForAgent, eRewardDict,rwds, isWeight=True):
        assert mark in set(['DQ','pressure','pressure2','pressure3','traffic','traffic2'])
        rewardsDict = {}
        rewardsStats = 0.
        agentLen = len(self.agentIdList)
        for i in range(agentLen):
